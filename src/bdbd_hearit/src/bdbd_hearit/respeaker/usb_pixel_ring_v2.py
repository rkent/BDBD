...
# Copy: https://github.com/furushchev/respeaker_ros/blob/master/config/60-respeaker.rules
# To: /etc/udev/rules.d
# See also: https://github.com/braiden/python-ant-downloader/issues/30#issuecomment-7119938
#
#!pip3 install pyusb
#
import usb.core
