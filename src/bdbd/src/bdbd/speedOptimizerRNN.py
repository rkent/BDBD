...
model = keras.models.load_model('models/modelrnn')
print(model.summary())
...
lefts =  [0.0, 1.0, 0.5, 0.2, 0.0]
rights = [0.0, 1.0, 0.5, 0.2, 0.0]
...
for count in range(NITERS):
    ...
    # setup deltas for derivative calculation
    ...
    # calculate losses for base speeds plus variants for derivatives
