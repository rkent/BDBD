'''
Nieve modeling of motion data, tenth second resolution
'''
import numpy as np
...
OutsSeq = np.load('data/OutsSeq_tenth.npy')
InsSeq = np.load('data/InsSeq_tenth.npy')
#for i in range(1000):
#    print(InsSeq[i, :, :])
...
history = model.fit(InsSeq, OutsSeq, epochs=100, validation_split=0.2)

model.save('data/modelnieve_tenth')
